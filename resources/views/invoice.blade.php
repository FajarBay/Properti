...
<div class="card">
    <div class="card-header">
        <div class="card-title"><img src="{{ public_path('asset/img/logo-nav.png') }}"></div><br>
        <div class="row">
            <div class="column">
                <table>
                    <tbody>
        ...
        <table class="table table-striped">
            ...
            <p class="text-center">
                Proper <img class="img" src="{{ public_path('asset/img/icon.png') }}"/> Sistem Informasi Penjualan Properti
            </p>
    </div>
</div>
@endforeach
