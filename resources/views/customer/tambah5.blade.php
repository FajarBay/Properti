                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {{-- <label class="form-radio-label">
                                                    <input class="form-radio-input" name="jenis" type="radio" {{{ (isset($properti->jenis) && $properti->jenis == '0') ? "checked" : "" }}} value="0">
                                                    <span class="form-radio-sign">Jual</span>
                                                </label></br>
                                                <label class="form-radio-label">
                                                    <input class="form-radio-input" name="jenis" type="radio" {{{ (isset($properti->jenis) && $properti->jenis == '1') ? "checked" : "" }}} value="1">
                                                    <span class="form-radio-sign">Sewa Harian</span>
                                                </label></br>
                                                <label class="form-radio-label">
                                                    <input class="form-radio-input" name="jenis" type="radio" {{{ (isset($properti->jenis) && $properti->jenis == '2') ? "checked" : "" }}} value="2">
                                                    <span class="form-radio-sign">Sewa Mingguan</span>
                                                </label></br>
                                                <label class="form-radio-label">
                                                    <input class="form-radio-input" name="jenis" type="radio" {{{ (isset($properti->jenis) && $properti->jenis == '3') ? "checked" : "" }}} value="3">
                                                    <span class="form-radio-sign">Sewa Bulanan</span>
                                                </label></br>
                                                <label class="form-radio-label">
                                                    <input class="form-radio-input" name="jenis" type="radio" {{{ (isset($properti->jenis) && $properti->jenis == '4') ? "checked" : "" }}} value="4">
                                                    <span class="form-radio-sign">Sewa Tahunan</span>
                                                </label> --}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label class="form-radio-label">
                                                    <input class="form-radio-input" name="nego" type="radio" {{{ (isset($properti->nego) && $properti->nego == '0') ? "checked" : "" }}} value="0">
                                                    <span class="form-radio-sign">Iya</span>
                                                </label></br>
                                                <label class="form-radio-label">
                                                    <input class="form-radio-input" name="nego" type="radio" {{{ (isset($properti->nego) && $properti->nego == '1') ? "checked" : "" }}} value="1">
                                            ...
                                            <a type="button" href="/properti4" class="btn btn-danger">Kembali</a>
                                        </div>
                                    </div>
                                    </form>
                                </div>
