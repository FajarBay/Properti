                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Detail Pemesanan
                                        <span class="badge badge-warning float-right">Maaf iklan ini sudah terjual</span>
                                ...
                                <div class=" card-body table-responsive ">
                                    ...
                                    <table class="table table-striped table-hover ">
                                        <tbody>
                                            ...
                                            <tr class="table-warning">
                                                <td><b>Informasi</b></td>
                                                <td>Anda sudah mengirimkan bukti pengembalian, silahkan buka menu <b>Pengembalian</b> atau klik <b>Lihat Pengembalian</b></td>
                                            </tr>
                                            @else
                                            <tr class="table-danger">
                                                <td><b>Informasi</b></td>
                                                <td>Iklan ini sudah terjual kepada pembeli yang lain, jika anda sudah melakukan pembayaran silahkan kirimkan bukti pembayaran anda untuk <b>Klaim Pengembalian</b></td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
                                    <div class="text-right" style="display:flex; float:right">
                                        ...
                                        <form action="{{route('pembayaran', $p->properti->id)}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <button type="submit" class="btn btn-success mr-1">Kalim Pengembalian</button>
                                        </form>
                                        @elseif($trans != null && $bukti == null)
                                        <form action="{{route('pengembalianLagi', $trans)}}" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-success mr-1">Kalim Pengembalian</button>
                                        </form>
                                        @else
                                        <a href="/pengembalian"><button type="submit" class="btn btn-success mr-1">Lihat Pengembalian</button></a>
                                        @endif
                                        <button class="btn btn-danger" data-toggle="modal" data-target="#hapus">Hapus Pemesanan</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h6>Apakah anda yakin akan menghapus pesanan ini? anda tidak akan dapat <b>Klaim Pengembalian</b> lagi</h6>
